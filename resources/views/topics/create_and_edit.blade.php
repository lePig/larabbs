    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="last_replay_user_id-field">Last_replay_user_id</label>
                    <input class="form-control" type="text" name="last_replay_user_id" id="last_replay_user_id-field" value="{{ old('last_replay_user_id', $topic->last_replay_user_id ) }}" />
                </div> 
                <div class="form-group">
