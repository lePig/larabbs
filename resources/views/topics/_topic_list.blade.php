            ...
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('users.show', [$topic->user_id ?:'']) }}">
                        <img class="media-object img-thumbnail" style="width: 52px; height: 52px;" src="{{ $topic->user->avatar or '' }}" title="{{ $topic->user->name or '' }}">
                    </a>
                </div>
                ...
                <div class="media-body">
                    ...
                    <div class="media-body meta">
                        ...
                        <span> • </span>
                        <a href="{{ route('users.show', [$topic->user_id]) }}" title="{{ $topic->user->name or '' }}">
